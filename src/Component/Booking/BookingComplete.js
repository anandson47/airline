    ...
    return (
        <div className="BookingComplete">
            ...
            <div className="cf">
                ...
                <button data-bs-toggle="modal" data-bs-target="#boardingpass" className="f6 link dim br2 ba bw1 ph3 pv2 mb2 dib black"><img src="/assets/images/ticket.png" className="w-20"/></button><br/>
                <a href="/">Book More Flights</a>
                </div>
            </div>
